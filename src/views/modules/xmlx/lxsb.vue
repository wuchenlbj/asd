...
<template>
  <div class="xmtj" style="height:100%;overflow-y:hidden;">
    ...
    <el-table v-loading="loadingtb" :data="tableData" :height="tableHeight" @row-dblclick="rowdblclick" border tooltip-effect="light" style="width: 100%">
      ...
      <el-table-column label="费用明细(万元)" align='center'>
        ...
        <el-table-column label="使用计划" align='center'>
          <el-table-column v-for="(item,index) in syjh" :key="index" v-bind:label="item.name" v-bind:prop="'FY'+item.id" show-overflow-tooltip width="90"></el-table-column>
        </el-table-column>
      </el-table-column>
