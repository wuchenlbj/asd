...
<template>
  <div class="jfsb">
    ...
    <el-table ref="tgyy" border style="width: 100%;margin-top:5px;" @select='selectRow' @select-all='selectallRow' :data="tableData" @row-dblclick="rowdblclick" :height="tableHeight" v-loading="loading" header-row-class-name="headclass">
...
export default {
  ...
  mounted() {
    this.tableHeight = this.rightHeight - 80
    this._GetTGXX()
