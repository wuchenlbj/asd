...
<template>
  <div class="list">
    <el-steps :active="activetab" finish-status="success" simple style="margin-bottom: 10px">
    ...
    <div v-if="activetab==1">
      ...
      <el-table size='mini' ref="psxm" border :data="xmxxSelect" style="width: 100%;margin:10px 0;">
        <el-table-column type="index" label="序号" width="50"></el-table-column>
        <el-table-column prop="XMBH" label="项目编号" show-overflow-tooltip min-width="100"></el-table-column>
        <el-table-column prop="XMMC" label="项目名称" show-overflow-tooltip min-width="120"></el-table-column>
        <el-table-column prop="KTBH" label="课题编号" show-overflow-tooltip min-width="100"></el-table-column>
    ...
    <template v-else-if="activetab==2">
      ...
      <el-radio-group @change="changeradio" v-model="grouptype" style="margin-top:10px;margin-bottom:10px;">
      ...
      <el-table border :data="listdata" ref="tablezj" v-loading='loading' @select='selectRow' @select-all='selectallRow' style="margin:10px 0;">
    ...
    <div v-if="activetab==3">
      <el-form ref="form" :model="form" label-width="90px">
        <el-form-item label="验收日期:">
          <el-date-picker v-model="form.PSSJ" type="datetime" placeholder="选择验收时间"></el-date-picker>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="save()" :loading="loadingbtn">保存配置</el-button>
...
<script>
import { getZY, getPsfs, savenewPSData } from "api/kxgzgl/pwgl.js"
  ...
  methods: {
    ...
    save() {
      ...
      for (var i = 0; i < this.xmxxSelect.length; i++) {
        ...
        this.form.BHS.push(arr.KTBH); // 课题编号
      }
      ...
      savenewPSData(this.form).then(response => {
